...
const DepartamentoSchema: Schema = new Schema(
	...
	{
		collection: 'ubigeo.departamentos',
		timestamps: true,
		versionKey: false
	}
);
...
/*******************************************************************************************************/
DepartamentoSchema.plugin(uniqueValidator, { message: '{VALUE}, ya se encuentra registrado' });

/*******************************************************************************************************/
// Exportamos el modelo de datos //
/*******************************************************************************************************/
export default model<IDepartamento>('UbigeoDepartamento', DepartamentoSchema);
